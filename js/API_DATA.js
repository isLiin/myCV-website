...
const experienceSkills = [
    {
        ...
        titleName: 'html5',
        type: 'language',
        experience: getYear(new Date('2020-08-01'))
    }, {
        icon: `
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                <path
        ...
        titleName: 'css3',
        type: 'language',
        experience: getYear(new Date('2020-08-07'))
    }, {
        icon: `
        ...
        titleName: 'jquery',
        type: 'framework',
        experience: getYear(new Date('2020-05-07'))
    }, {
        icon: `
        ...
        titleName: 'bootstrap',
        type: 'framework',
        experience: getYear(new Date('2021-01-07')),
    }, {
        icon: `
